window.addEventListener('load', function () { //Escuchamos cuando se carga el documento
    ...
    const keytpadButtonsArray = Array.from(keypadButtons);

    // Itearamos por nuestro nuevo array de botones
    keytpadButtonsArray.forEach(function (button) {
